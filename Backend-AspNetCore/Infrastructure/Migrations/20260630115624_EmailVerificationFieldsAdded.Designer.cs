...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260630115624_EmailVerificationFieldsAdded")]
    partial class EmailVerificationFieldsAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Models.BanRecord", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_ban_records_user_id");
            ...
            modelBuilder.Entity("Entities.Models.SellerAddress", b =>
                {
                    ...
                    b.HasIndex("SellerId")
                        .HasDatabaseName("ix_seller_addresses_seller_id");
            ...
            modelBuilder.Entity("Entities.Models.SellerFinance", b =>
                {
                    ...
                    b.HasIndex("SellerId")
                        .HasDatabaseName("ix_seller_finances_seller_id");
            ...
            modelBuilder.Entity("Entities.Models.WarningRecord", b =>
                {
                    ...
                    b.Property<long>("WarnedByUserId")
                        .HasColumnType("bigint")
                        .HasColumnName("warned_by_user_id");

                    b.HasKey("Id")
                        .HasName("pk_warning_records");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_warning_records_user_id");
            ...
            modelBuilder.Entity("Entities.Models.BanRecord", b =>
                {
                    b.HasOne("Entities.Models.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_ban_records_users_user_id");
            ...
            modelBuilder.Entity("Entities.Models.SellerAddress", b =>
                {
                    b.HasOne("Entities.Models.Seller", "Seller")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_seller_addresses_sellers_seller_id");
            ...
            modelBuilder.Entity("Entities.Models.SellerFinance", b =>
                {
                    b.HasOne("Entities.Models.Seller", "Seller")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_seller_finances_sellers_seller_id");
            ...
            modelBuilder.Entity("Entities.Models.WarningRecord", b =>
                {
                    b.HasOne("Entities.Models.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_warning_records_users_user_id");
