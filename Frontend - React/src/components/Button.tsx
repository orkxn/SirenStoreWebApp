...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = 'inline-flex items-center justify-center font-medium rounded-full transition-all duration-300 outline-none focus:ring-2 focus:ring-zinc-400 focus:ring-offset-2 dark:focus:ring-offset-zinc-950 disabled:opacity-40 disabled:cursor-not-allowed';
